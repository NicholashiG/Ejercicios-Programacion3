...
public class LaberintoVS {
	...
	public static void main(String[] args) {
		LaberintoVS m = new LaberintoVS(); // construimos un objeto de la clase Laberinto por defecto
		m.laberinto[1][1] = 'X'; // introducimos en este caso, la salida (X) en las coordenadas (1,1)
		m.resuelve(8, 1, m); // ahora, introducimos la entrada (S) en las coordenadas (8,1)
		// y llamamos al algoritmo
		// imprimimos el laberinto ya resuelto (si tiene solución)
	}

	/* ----------------- IMPLEMENTACIÓN DEL ALGORITMO ----------------- */
	public void resuelve(int x, int y, LaberintoVS m) { // permite introducir unas coordenadas (x, y)
	...
	private boolean paso(int x, int y, LaberintoVS m) {
		...
		laberinto[x][y] = ' '; // al dar vuelta atrás se debe limpiar el camino ya hecho para
